...
(function () {
  ...
  var TOUR = [
    { btn: function () { return addBtn; }, title: "Annotate ✒️", body: "Tap Annotate and pick a tool — 📍 pin a spot, ▭ box an area, 🖍 highlight words, ✎ draw. Then mark the page and type what should change." },
