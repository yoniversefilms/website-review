...
(function () {
  ...
  /* ---------------- capture (pin + draw) ---------------- */
  var captureLayer = null, hintEl = null, live = null, prevOverflow = null;
  var HINTS = { pin: "Tap the spot you want to comment on", draw: "Draw on the page to point something out" };
