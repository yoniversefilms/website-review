...
(function () {
  ...
  var TOUR = [
    ...
    { btn: function () { return listBtn; }, title: "Notes", body: "Every note lands here. Tap one to jump to its exact spot on the page, reply, or mark it resolved." },
  ...
  function card(n) {
    ...
    if (n.disposition === "fix") meta.appendChild(el("span", "wr-tag wr-tag--fix", "🔧 fix"));
    if (n.disposition === "parked") meta.appendChild(el("span", "wr-tag wr-tag--park", "⏸ parked"));
  ...
  function cardBody(n) {
    ...
    if (n.owner_note) { var on = el("div", "wr-anchor"); on.setAttribute("dir", "auto"); on.textContent = "🔧 For Claude: " + n.owner_note; wrapc.appendChild(on); }
  ...
  window.__wr = { arm: arm, notes: function () { return notes; }, comments: function () { return comments; }, fetch: fetchNotes, board: BOARD, sidebar: openSidebar, tour: function () { runTour(0); } };
})();
